...
| 维度 | TLD | aria2 | libtorrent | libcurl | reqwest |
|------|----------|-------|------------|---------|---------|
...
| 协议 | TLD | aria2 | libtorrent | libcurl | reqwest |
|------|----------|-------|------------|---------|---------|
| HTTP/HTTPS | ✅ | ✅ | ❌ | ✅ | ✅ |
| HTTP/3 (QUIC) | ✅ | ❌ | ❌ | ❌ | ❌ |
| FTP | ✅ | ✅ | ❌ | ✅ | ❌ |
...
| 平台 | TLD | aria2 | libtorrent | libcurl | reqwest |
|------|----------|-------|------------|---------|---------|
| Windows | ✅ 原生 | ✅ | ✅ | ✅ | ✅ |
| Linux | ✅ 原生 | ✅ | ✅ | ✅ | ✅ |
| macOS | ✅ 原生 | ✅ | ✅ | ✅ | ✅ |
...
| 语言 | TLD | aria2 | libtorrent | libcurl | reqwest |
|------|----------|-------|------------|---------|---------|
| Rust | ✅ 原生 | ❌ | ❌ | ✅ FFI | ✅ 原生 |
...
|------|-----------|-----------------|------|
| TLD | ~10-15 MB | ~15-20 MB | Rust 零成本抽象 |
