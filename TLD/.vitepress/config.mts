...
export default defineConfig({
  ...
  themeConfig: {
    logo: 'https://images-sxxyrry.pages.dev/TLD_Bigger.png',
    outline: {
      label: '在本页面'
    },
    docFooter: {
    ...
    editLink: {
      pattern: 'https://github.com/sxxyrry/docssCode/edit/main/TLD/:path',
      text: '在 Github 上编辑此页'
    },
    sidebarMenuLabel: '菜单',
    ...
    nav: [
      { text: '首页', link: '/' },
      { text: '什么是 TLD 核心', link: '/zh/guide/what-is-TLD-Core' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/TaiLerDownloader/' }
    ]
  }
  ,
  head: [
