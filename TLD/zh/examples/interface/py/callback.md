...
使用 TLD 的 Python 接口，您可以获得以下性能提升：
...
此回调函数示例完全兼容 TTHSD Golang 版本。如果您正在使用 TTHSD Golang 版本，只需将动态库文件替换为 TaiLerDownloader.dll/so/dylib 即可，代码无需修改。