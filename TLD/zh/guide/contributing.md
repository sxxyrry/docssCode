...
感谢您对 TLD 项目的关注和贡献意愿！本文档将指导您如何参与 TLD 的开发。

> [!TIP]
> 本文档介绍的是 **TLD**（Rust 版本）的贡献指南。
> 
...
输出文件: ***target\release\TaiLerDownloader.dll***
...
输出文件: ***target/release/libTaiLerDownloader.so***
...
输出文件: ***target/release/libTaiLerDownloader.dylib***
...
通过向 TLD 项目贡献代码，您同意您的贡献将遵循项目的 [GNU General Public License v3.0](https://www.gnu.org/licenses/gpl-3.0.en.html) 许可证。

注意：文档采用 [GNU Affero General Public License v3.0](https://www.gnu.org/licenses/agpl-3.0.en.html) 许可证

## 联系方式

- **GitHub Issues**: [提交 Issue](https://github.com/TaiLerDownloader/TaiLerDownloader/issues)
- **Pull Requests**: [发起 PR](https://github.com/TaiLerDownloader/TaiLerDownloader/pulls)
- **Discussions**: [参与讨论](https://github.com/TaiLerDownloader/TaiLerDownloader/discussions)

## TLD vs TTHSD Golang

请注意，本文档仅适用于 TLD（Rust 版本）。TTHSD Golang 已停止开发，不再接收贡献。如果您想为 TTHSD Golang 版本贡献，请注意：
